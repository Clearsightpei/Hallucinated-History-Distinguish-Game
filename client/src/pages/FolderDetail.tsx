    ...
    <div>
      ...
      {stories.length === 0 ? (
        ...
        <div className="space-y-4">
          {stories.map((story) => (
            <Card key={story.id} className="bg-white shadow rounded-lg overflow-hidden">
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="text-lg font-medium text-neutral-800">{story.event}</h3>
                    <p className="mt-1 text-sm text-neutral-500 line-clamp-2">{story.introduction}</p>
                  </div>
                ...
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="border border-neutral-200 rounded-md p-3 bg-neutral-50">
                    <p className="text-xs font-medium text-neutral-500 mb-1">True Version:</p>
                    <p className="text-sm text-neutral-700 line-clamp-3">{story.true_version}</p>
                  </div>
                  <div className="border border-neutral-200 rounded-md p-3 bg-neutral-50">
                    <p className="text-xs font-medium text-neutral-500 mb-1">Fake Version:</p>
                    <p className="text-sm text-neutral-700 line-clamp-3">{story.fake_version}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
